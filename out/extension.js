...
async function activate(context) {
    ...
    if (watchUri) {
        ...
        const onFileChange = async (uri) => {
            ...
            const selection = await vscode.window.showInformationMessage(`File changes detected in ${currentProjectName}.`, 'Sync Now');
...
function deactivate() { }
async function findFiles(folderUri) {
    const files = [];
